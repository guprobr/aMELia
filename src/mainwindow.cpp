    ...
    , m_busyFrames({QStringLiteral("◐"), QStringLiteral("◓"), QStringLiteral("◑"), QStringLiteral("◒")})
{
    ...
    auto *title = new QLabel(QStringLiteral("Amelia Qt6 - Local-first WRCP Assistant"), chatPane);
...
void MainWindow::setAvailableModels(const QStringList &models, const QString &currentModel)
{
    ...
    if (uniqueModels.isEmpty()) {
        uniqueModels << (currentModel.trimmed().isEmpty() ? QStringLiteral("qwen2.5-coder:7b") : currentModel.trimmed());
    }
...
void MainWindow::showAboutAmelia()
{
    QMessageBox::about(this,
                       ...
                       QStringLiteral("<b>Amelia Qt6</b><br><br>"
                                      "A local-first WRCP, Linux and systems engineering assistant built with C++ and Qt6.<br><br>"
