...
void MainWindow::showAboutAmelia()
{
    QMessageBox::about(this,
                       ...
                       QStringLiteral(
                           ...
                           "<li>Optional sanitized external web search via SearXNG, with fetched results framed "
                           "as untrusted data so page content can't hijack the model's instructions</li>"
                           "<li>OCR tries Portuguese + English (falls back to English-only automatically)</li>"
                           "</ul>")
